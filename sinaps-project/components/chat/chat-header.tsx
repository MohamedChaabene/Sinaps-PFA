...
export function ChatHeader({
  ...
  return (
    <header className="flex items-center justify-between gap-3 border-b border-border/70 bg-card/85 backdrop-blur-md px-4 py-2.5 sm:px-6 shadow-xs sticky top-0 z-20">
