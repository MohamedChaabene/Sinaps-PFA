...
\begin{figure}[H]
  ...
  \caption{Tableau de bord administrateur de SINAPS}
...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item \textbf{Important --- Dashboard administrateur}. Capture de \texttt{/admin} montrant les KPI, la validation des agents et l'historique filtrable. Placement : après le paragraphe sur l'espace administrateur. Caption : \textit{Tableau de bord administrateur de SINAPS}. Label : \texttt{fig:admin-dashboard}.
