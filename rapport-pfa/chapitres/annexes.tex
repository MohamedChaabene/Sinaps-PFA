...
À cocher après insertion dans le chapitre~4 :

\begin{itemize}[leftmargin=1.4em]
  \item[$\square$] Identification client (Google)
  \item[$\square$] Chat + réponse Gemini / RAG
  \item[$\square$] Pièce jointe
  \item[$\square$] Escalade et file agent
  \item[$\square$] Message humain
  \item[$\square$] Satisfaction
  \item[$\square$] Login staff
  \item[$\square$] Inscription agent
  \item[$\square$] Dashboard admin (stats, validation, historique)
\end{itemize}
