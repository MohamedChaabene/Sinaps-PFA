...
\caption{Diagramme de séquence du cas d'utilisation « Envoyer un message ou une pièce jointe »}
...
\caption{Diagramme de séquence du cas d'utilisation « Utiliser une action rapide »}
...
\caption{Diagramme de séquence du cas d'utilisation « Demander un agent humain »}
...
\caption{Diagramme de séquence du cas d'utilisation « Revenir vers l'IA »}
...
\caption{Diagramme de séquence du cas d'utilisation « Clôturer et évaluer »}
...
\caption{Diagramme de séquence du cas d'utilisation « Consulter la file de conversations »}
...
\caption{Diagramme de séquence du cas d'utilisation « Prendre en charge une conversation »}
...
\caption{Diagramme de séquence du cas d'utilisation « Répondre au client »}
...
\caption{Diagramme de séquence du cas d'utilisation « Résoudre une conversation »}
...
\caption{Diagramme de séquence du cas d'utilisation « Rendre la conversation à l'IA »}
...
\caption{Diagramme de séquence du cas d'utilisation « Valider ou supprimer un agent »}
...
\caption{Diagramme de séquence du cas d'utilisation « Consulter et filtrer l'historique »}
...
\caption{Diagramme de séquence du cas d'utilisation « Consulter les statistiques »}
