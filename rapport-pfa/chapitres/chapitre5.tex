...
Le frontend Next.js et le client mobile Expo / React Native ne contiennent pas de suite de tests unitaires dédiée dans le dépôt. Le client mobile passe toutefois la vérification de typage \texttt{npx tsc --noEmit}. Une validation manuelle des écrans est possible avec Google, Gemini et Atlas, mais ses date, scénarios et résultats détaillés ne figurent pas dans les sources disponibles : \acompleter{compléter uniquement si ces éléments sont confirmés}.
