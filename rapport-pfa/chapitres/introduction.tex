...
Le sujet de stage proposé par \textbf{Kais Gharred} au sein de \textbf{SINAPS TEC} vise à concevoir une application de support \og assistée par un agent IA \fg{}, proche d'un canal de discussion de type Slack : l'utilisateur pose une question, un agent IA s'appuie sur une \textbf{base de connaissances} (approche RAG) pour répondre, un \textbf{workflow} suit la demande, et l'utilisateur peut à tout moment \textbf{basculer vers un opérateur humain}. Un administrateur valide les comptes des agents et supervise l'historique ainsi que des indicateurs opérationnels de satisfaction et de délai de réponse.

Ce Projet de Fin d'Année s'inscrit dans le cycle ingénieur en \textbf{Génie Logiciel} (2\textsuperscript{e} année) à l'\textbf{ISIMS} (Université de Sfax). Le stage s'est déroulé \textbf{à distance}, du \textbf{22 juin 2026} au \textbf{6 septembre 2026}, et a été réalisé \textbf{seul}. Le livrable logiciel comprend une application \textbf{web} fullstack et un client mobile \textbf{Expo / React Native}, tous deux connectés au backend commun. Le web constitue le client principalement documenté et validé ; le mobile couvre le parcours client ainsi que des écrans agent et administrateur, mais ne constitue pas une copie fonctionnellement identique du web et aucune recette formelle de cette version n'est documentée.
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item valider le comportement par des tests automatisés et examiner les intégrations configurées avec Google Sign-In, Gemini et MongoDB.
\end{itemize}
