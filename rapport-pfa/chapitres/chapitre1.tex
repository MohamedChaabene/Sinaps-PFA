...
L'organisme d'accueil du stage est \textbf{SINAPS}, acronyme de \textit{Solutions Innovations For Networks, Applications \& Portable Systems}. Le stage a été proposé et suivi par \textbf{M.~Kais}, contacté à l'adresse \texttt{sinapstec@gmail.com}.
...
\begin{itemize}[leftmargin=1.4em]
  \item siège social, ville et forme juridique : \acompleter{coordonnées officielles de SINAPS} ;
...
Dans le cadre de ce PFA, SINAPS intervient comme \textbf{commanditaire du sujet} : le besoin fonctionnel, la stack suggérée et le périmètre (chat de support, RAG, escalade humaine, administration) ont été définis par l'encadrant professionnel, puis réalisés en autonomie.
...
\midrule
Organisme & SINAPS \\
Encadrant professionnel & M.~Kais (\texttt{sinapstec@gmail.com}) \\
...
Le produit livré est une application \textbf{web} (interface responsive). Le sujet suggérait également une application mobile native (React Native / Flutter) : celle-ci \textbf{n'a pas été développée} pendant le stage.
