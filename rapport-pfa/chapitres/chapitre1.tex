...
Le produit livré comprend une application \textbf{web} (interface responsive) et un client mobile \textbf{Expo / React Native} connecté au même backend. Le mobile couvre l'authentification, le chat, les réponses IA, l'escalade humaine, la clôture avec satisfaction, les pièces jointes, le temps réel Socket.io, ainsi que des écrans agent et administrateur. Il ne constitue toutefois pas une copie fonctionnellement identique du web : les actions rapides contextuelles du web sont remplacées par des suggestions statiques, et la connexion Google mobile nécessite une build native Expo configurée. Aucune recette formelle de cette version n'est documentée.
